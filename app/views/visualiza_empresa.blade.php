    ...
    <div class="medium-10 columns form-pesquisa">
        <div class="row">
            ...
            <div class="medium-1 columns">
                <button class="button tiny radius" title="Pesquisar" type="submit"><i class="fi-magnifying-glass"></i></button>
...
<div class="row">
    <div class="medium-12 columns">
        <ul class="bxslider">
            ...
            <li><img src="{{ URL::to('/')}}/img/banner/TP_TECLACERTA.jpg" /></li>
                    ...
                    <div class="medium-12 columns">
                        ...
                        <div class="row">
                            ...
                            <div class="medium-7 columns">
                                ...
                                @endif
                                @if($s->link_gp != null)
                                <a href="#" class="webicon googleplus"></a>
                                @endif
                                @if($s->link_tw != null)
                                <a href="#" class="webicon twitter"></a>
                                @endif
                                @if($s->link_li != null)
                                <a href="#" class="webicon linkedin"></a>
                                @endif
                                @if($s->link_yt != null)
                                <a href="#" class="webicon youtube"></a>
                                @endif
                                @if($s->link_is != null)
                                <a href="#" class="webicon instagram"></a>
                                @endif
                                @endif
                                @endforeach
                            </div>
