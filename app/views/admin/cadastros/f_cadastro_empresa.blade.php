        ...
        <div class="row">
            <div id="corpo">
                <div id="conteudo" class="col-md-offset-1 col-sm-offset-1 col-lg-offset-1 col-md-10 col-sm-10 col-lg-10"><!-- Inicio da area do conteudo -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="form-group">
                                ...
                                {{ Form::select('uf', $estados, 0, array('class'=>'form-control')) }}
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <div class="form-group">
                                {{ Form::label('cidade', 'Cidade*') }}
                                {{ Form::select('cidade', array('0'=>'Selecione o estado'), '', array('class'=>'form-control')) }}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <br />
                    {{ Form::button('Próximo', array('type'=>'submit', 'class'=>'btn btn-default', 'title'=>'Cadastrar dados da empresa')) }}
                    <br /><br />
                    {{Form::close()}}
